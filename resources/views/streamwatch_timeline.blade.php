...
<head>
    ...
    <title>Arsip Sensor - StreamWatch</title>
    ...
    <nav class="bg-gray-800 border-b border-gray-700 p-4 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="space-x-6 text-sm font-medium text-gray-400">
                ...
                <a href="{{ route('timeline') }}" class="text-red-400 border-b-2 border-red-500 pb-1">Arsip Sensor</a>
                <a href="{{ route('factcheck') }}" class="hover:text-white transition">Fact-Check</a>
                <a href="{{ route('dampak') }}" class="hover:text-white transition">Dampak Sosial</a>
                <a href="{{ route('pustaka') }}" class="hover:text-white transition">Pustaka</a>
            </div>
        </div>
    </nav>
        ...
        <div class="relative border-l border-gray-700 ml-4 space-y-12">
            ...
            <div class="mb-8 ml-8 relative">
                ...
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    <div
                        class="inline-block bg-red-900/30 text-red-300 text-xs px-2 py-1 rounded border border-red-800">
            ...
            <div class="mb-8 ml-8 relative">
                <span
                    class="absolute -left-11 top-1 bg-yellow-500 w-6 h-6 rounded-full border-4 border-gray-900"></span>
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="text-xl font-bold text-white">Throttling Instagram (Penurunan Bandwidth)</h3>
